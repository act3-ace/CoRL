...
from corl.evaluation.metrics.processors import Processor
...
class SceneProcessors:
    ...
    world: Processor
    participants: typing.Dict[str, Processor]
    ...
    @staticmethod
    def from_evaluation(
        evaluation_data: typing.List[EpisodeArtifact],
        scenario_metric_generators: ScenarioMetricGenerators,
        scenario_alert_generators: ScenarioAlertGenerators
    ) -> 'SceneProcessors':
        ...
        contained_participants: typing.List[str] = []
        for episode_artifact in evaluation_data:
            for agent_id in episode_artifact.steps[0].agents.keys():
                if agent_id not in contained_participants:
                    contained_participants.append(agent_id)

        # Process any world metrics
        world_evaluation_metrics: metrics.processors.Processor = metrics.processors.Evaluation.process(
            evaluation_data,
        ...
        participant_evaluation_metrics: typing.Dict[str, metrics.processors.Processor] = {}
